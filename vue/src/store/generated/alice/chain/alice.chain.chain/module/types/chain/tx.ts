...
const baseMsgCreatePost: object = { creator: '', foobar: '' }
...
export const MsgCreatePost = {
  encode(message: MsgCreatePost, writer: Writer = Writer.create()): Writer {
    ...
    if (message.foobar !== '') {
      writer.uint32(18).string(message.foobar)
    }
    return writer
  },
  ...
  fromJSON(object: any): MsgCreatePost {
    ...
    if (object.foobar !== undefined && object.foobar !== null) {
      message.foobar = String(object.foobar)
    } else {
      message.foobar = ''
    }
    return message
  ...
  toJSON(message: MsgCreatePost): unknown {
    ...
    message.foobar !== undefined && (obj.foobar = message.foobar)
    return obj
  },
...
const baseMsgUpdatePost: object = { creator: '', id: 0, foobar: '' }
...
export const MsgUpdatePost = {
  encode(message: MsgUpdatePost, writer: Writer = Writer.create()): Writer {
    ...
    if (message.foobar !== '') {
      writer.uint32(26).string(message.foobar)
    }
    return writer
  },

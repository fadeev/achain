...
import (
	...
	"github.com/alice/chain/x/chain"
	chainkeeper "github.com/alice/chain/x/chain/keeper"
	chaintypes "github.com/alice/chain/x/chain/types"
)
...
func New(
	...
	app.ChainKeeper = *chainkeeper.NewKeeper(
		appCodec,
		keys[chaintypes.StoreKey],
		keys[chaintypes.MemStoreKey],
	)
	chainModule := chain.NewAppModule(appCodec, app.ChainKeeper)
